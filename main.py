...
def parse_args():
    ...
    p.add_argument("--data-dir", default=None, help="Graph/chunk data dir, e.g. ./GRAPHDATA")
    p.add_argument("--data-dir-out", default=None, help="Graph output dir, e.g. ./GRAPHDATA_OUTPUT")
